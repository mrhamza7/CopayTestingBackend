    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CopaymentRules", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CopaymentRules_InsuranceProviders_InsuranceProviderId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClinicId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ClinicStaffId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Appointments_ClinicStaff_ClinicStaffId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Insurances_InsuranceProviders_InsuranceProviderId",
                        column: x => x.InsuranceProviderId,
                        principalTable: "InsuranceProviders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_HealthRecords_ClinicStaff_ClinicStaffId",
                        column: x => x.ClinicStaffId,
                        principalTable: "ClinicStaff",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Copayments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Copayments_Appointments_AppointmentId",
                        column: x => x.AppointmentId,
                        principalTable: "Appointments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Copayments_Insurances_InsuranceId",
                        column: x => x.InsuranceId,
                        principalTable: "Insurances",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Copayments_Patients_PatientId",
                        column: x => x.PatientId,
                        principalTable: "Patients",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.InsertData(
                table: "Roles",
                columns: new[] { "Id", "CreatedAt", "DeletedAt", "Description", "IsDeleted", "Name", "NormalizedName", "UpdatedAt" },
                values: new object[,]
                {
                    { new Guid("4fd681b6-5dd2-4a5a-aa9e-b2806c61d4ca"), new DateTime(2023, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "Patient with limited access to personal data", false, "Patient", "PATIENT", null },
                    { new Guid("8d04dce2-969a-435d-bba4-df3f325983dc"), new DateTime(2023, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "Super Administrator with full system access", false, "SuperAdmin", "SUPERADMIN", null },
                    { new Guid("cfd242d3-2107-4563-b2a4-15383e683964"), new DateTime(2023, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "Clinic Administrator with clinic-level access", false, "ClinicAdmin", "CLINICADMIN", null }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Appointments_ClinicStaffId",
                table: "Appointments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CopaymentRules_InsuranceProviderId",
                table: "CopaymentRules",
                column: "InsuranceProviderId");

            migrationBuilder.CreateIndex(
                name: "IX_Copayments_AppointmentId",
                table: "Copayments",
                column: "AppointmentId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Copayments_InsuranceId",
                table: "Copayments",
                column: "InsuranceId");

            migrationBuilder.CreateIndex(
                name: "IX_Copayments_PatientId",
                table: "Copayments",
                column: "PatientId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HealthRecords_ClinicStaffId",
                table: "HealthRecords",
                column: "ClinicStaffId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Insurances_InsuranceProviderId",
                table: "Insurances",
                column: "InsuranceProviderId");
